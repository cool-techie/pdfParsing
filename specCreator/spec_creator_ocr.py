...
def create_ocr_specs_knowledge_base():
    specs = []

    spec1_pk = ['16 CFR 1303', 'CPSIA Section 101', 'CPSIA S.101', 'ASTM F963-11', 'CPSC-CH-E1003-09.1', '16 CFR Part 1303']
    apk1 = ['16', 'CFR', '1303']
    apk2 = ['CPSIA', '101']
    ...
    spec3_pk = ['CPSIA Section 106', 'ASTM F963-11', 'ASTM F2923-14']
    apk3_1 = ['CPSIA', '106']
    apk3_2 = ['Consumer', 'Product', 'Safety', 'Improvement', 'Act', '2008', '106']
    apk3_3 = ['ASTM', 'F96311']  # sometimes - is omitted by OCR
    spec3_apks = [apk3_1, apk3_2, apk3_3]
    spec3_sk = ['soluble heavy'] # some tests might have `metals` some might have `elements`
    spec3 = SpecNode('S000397', 'CPSIA Section 106', spec3_pk, spec3_apks, spec3_sk)
    specs.append(spec3)
